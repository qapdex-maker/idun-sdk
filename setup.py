...
setup(
    name="idun-sdk",
    version=VERSION,
    description="Stdlib-only client + CLI for the Azure AI Foundry agent NatureLM-Idun-5-MoE, with a 17-provider registry (openai/anthropic/groq/openrouter/together/deepseek/mistral/gemini/xai/nous/hf/ollama/perplexity/fireworks/novita/...) and a 16-bit retro console",
